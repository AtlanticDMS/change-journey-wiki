...
## Core concepts
- [[DYOR - Do Your Own Research]] — the foundational mindset
- [[Marketing Intelligence]] — evolution from surveys to AI-powered analytics
- [[Concepts/Data-Driven Decision Making|Data-Driven Decision Making]] — grounding strategy in evidence
- [[Concepts/Analytics Framework]] — the organisational infrastructure for systematic data use
- [[Data-Driven Culture]] — embedding evidence-based thinking into DNA
- [[Data Quality and Integrity]] — clean data as the non-negotiable foundation
...
- [[W. Edwards Deming]] — "All others must bring data"

## Best entry points
- [[Concepts/Data-Driven Decision Making|Data-Driven Decision Making]] — why it matters
- [[Analytics Framework]] — how to build the capability
- [[Data-Driven Culture]] — the human dimension
- [[Evidence-Based Leadership]] — the series-level synthesis

## Open questions
- How does a solo-operator SMB start with analytics given resource constraints?
- What is the minimum viable analytics stack for a 5-person business?
- How do cognitive biases interact with AI-generated insights — does AI reduce or amplify them?
